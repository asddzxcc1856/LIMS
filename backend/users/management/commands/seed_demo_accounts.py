...
DEMO_ORG = [
    ...
    ('Lab_Mem_Photo_001',   'lab_member',       'Photolithography Lab',
     '光刻 WIP 協調員', 'Litho Lot Coordinator — 接件 / 分貨'),
    ...
    ('Lab_Mem_Photo_004',   'lab_member',       'Photolithography Lab',
     '光刻設備操作員', 'Stepper / Track Operator — 機台執行'),
    ...
    ('Lab_Mem_Process_001', 'lab_member',       'Thin Film & Etch Lab',
     '薄膜蝕刻 WIP 協調員', 'Process Lot Coordinator — 接件 / 分貨'),
    ...
    ('Lab_Mem_Process_004', 'lab_member',       'Thin Film & Etch Lab',
     '薄膜蝕刻設備操作員', 'Etch / Deposition Tool Operator — 機台執行'),
    ...
    ('Lab_Mem_QC_001',      'lab_member',       'Metrology & Inspection Lab',
     '量測 WIP 協調員', 'Metrology Lot Coordinator — 接件 / 分貨'),
    ...
    ('Lab_Mem_QC_004',      'lab_member',       'Metrology & Inspection Lab',
     '量測設備操作員', 'Metrology Tool Operator (CD-SEM / Defect Inspect) — 機台執行'),
...
class Command(BaseCommand):
    ...
    def _reseed(self):
        ...
        for username, role, dept_name, first_name_zh, label in DEMO_ORG:
            ...
            # Idempotent display-name refresh — keeps existing demo
            # accounts in lockstep with the DEMO_ORG table without
            # forcing a password / role / department change. Only
            # touches first_name + last_name; everything else (incl.
